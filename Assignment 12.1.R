#Downloaded the communities.data file, format changed to communities.csv for import to proceed with analysis
...
# Trying to understand when crime is higher at certain time and vice versa
...
# Changing the arrest as per value/numeric
